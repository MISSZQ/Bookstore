                ...
                <td id="left_cont">
                    <table width="100%" height="100%">
                        ...
                        <tr>
                            ...
                            <td width="60%">
                                <table width="100%">
                                    <tr height="70"><td align="right"><img src="./Images/logo.gif" title="瑞曼科技" alt="瑞曼科技" /></td></tr>
                                    <tr height="274">
                    ...
                    <table height="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top" id="form">
                                <form action="${pageContext.request.contextPath}/admin_login.do" accept-charset="utf-8" method="post" id="loginForm">
                                    <table valign="top" width="50%">
                                        <tr><td colspan="2"><h4 style="letter-spacing:1px;font-size:16px;">RainMan 网站管理后台</h4></td></tr>
                                        <tr><td>管理员：</td><td><input type="text" name="adminName" value="" /></td></tr>
                                        <tr><td>密&nbsp;&nbsp;&nbsp;&nbsp;码：</td><td><input type="password" name="adminPassword" value="" /></td></tr>                                
