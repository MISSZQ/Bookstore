            ...
            <td width="182" valign="top">
                <div id="container">
                    ...
                    <div class="content">
                        ...
                        <ul class="RM">
                            <li><a href="cat_add.jsp" target="main">添加管理员</a></li>
                            <li><a href="${pageContext.request.contextPath}/user_list.do" target="main">用户管理</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="content">
                        ...
                        <ul class="RM">
                            ...
                            <li><a href="${pageContext.request.contextPath}/book_list.do" target="main">产品列表</a></li>
                        </ul>
                    </div>
